...
currently implements axes #1 (camera pose), #2 (object pose) and
#3 (lighting) as three separate warm-up scripts; production datasets
need all six and will combine the axes per frame.
