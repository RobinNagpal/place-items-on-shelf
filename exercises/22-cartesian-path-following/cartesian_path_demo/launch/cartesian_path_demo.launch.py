#!/usr/bin/env python3
"""Launch the cartesian_path_demo node with addison's MoveIt config attached.

Same launch shape as exercises 18-21. Reuses exercise 1's v1 world
(no need for the v2 housing wall in Gazebo - the wall is added as a
planning-scene collision object at runtime).
