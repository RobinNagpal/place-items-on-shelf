...
| 27 | [`27-synthetic-detection-dataset/`](27-synthetic-detection-dataset/) | F.27 — Synthetic detection dataset: procedural top-down rack render, YOLO + COCO + per-instance masks, label-vs-mask IoU = 1.0 | done |
