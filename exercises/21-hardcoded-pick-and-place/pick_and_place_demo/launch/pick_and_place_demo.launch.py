#!/usr/bin/env python3
"""Launch the pick_and_place_demo node with addison's MoveIt config attached.

Same launch shape as exercises 18-20. We reuse the v1 world from
exercise 1 (../../01-custom-gazebo-world/worlds/autosampler_cell.sdf).
The autosampler housing wall is added as a MoveIt collision object at
runtime - it is NOT drawn in Gazebo for this exercise. RViz's
PlanningScene display will show it.
